...
public class EventBusLoggerTests : IAsyncDisposable
{
    ...
    private readonly FileEventBusLogger _logger;
    ...
    public EventBusLoggerTests()
    {
        ...
        _logger = new FileEventBusLogger(new EventModuleConfiguration { EventBusLoggerPath = _testLogPath });
    ...
    {
        NullEventBusLogger logger = new NullEventBusLogger();
        TestEvent1 testEvent = new TestEvent1();
        Result[] results = [Result.Success()];
